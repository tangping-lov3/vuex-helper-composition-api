...
var useMapState = function() {
  ...
  return withComputed(mapState.apply(void 0, _toConsumableArray(args)));
};
var useMapGetters = function() {
  for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
    args[_key] = arguments[_key];
  }
  return withComputed(mapGetters.apply(void 0, _toConsumableArray(args)));
};
var useMapActions = function() {
  for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
    args[_key] = arguments[_key];
  }
  var actions = mapActions.apply(void 0, _toConsumableArray(args));
  var ctx = getContext();
...
var useMapMutations = function() {
  ...
  var mutations = mapMutations.apply(void 0, _toConsumableArray(args));
  var ctx = getContext();
